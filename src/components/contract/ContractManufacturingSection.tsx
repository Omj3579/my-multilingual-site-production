              ...
              >
                <div className="space-y-6">
                  <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
                    {language === 'en'
                      ? "With decades of experience and continual innovation, Flair-Plastic offers cutting-edge technology for injection moulding projects globally. Beyond that, we offer a comprehensive suite of services that encompasses managed and strategic manufacturing, from the initial product concept and design to logistics and delivery."
                      : "Több évtizedes tapasztalattal és folyamatos innovációval a Flair-Plastic élvonalbeli technológiát kínál fröccsöntési projektekhez világszerte. Ezen túlmenően átfogó szolgáltatáscsomagot kínálunk, amely magában foglalja az irányított és stratégiai gyártást, a kezdeti termékkoncepciótól és tervezéstől kezdve a logisztikáig és szállításig."}
                  </p>
                  ...
                  <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
                    {language === 'en'
                      ? "Our extensive capabilities enable us to support you at every manufacturing stage. Get in touch to discover how we can assist with your strategic manufacturing requirements."
                      : "Kiterjedt képességeink lehetővé teszik, hogy a gyártás minden szakaszában támogassuk Önt. Vegye fel velünk a kapcsolatot, hogy felfedezze, hogyan segíthetünk stratégiai gyártási igényeivel."}
                  </p>
              ...
              >
                ...
                <div className="bg-gradient-to-br from-amber-50 to-white rounded-2xl p-8 shadow-lg border border-amber-100 relative z-10">
                  <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-6 italic">
                    {language === 'en'
                      ? "At Flair-Plastic, we have strategically guided our growth over the past three decades to maintain our flexibility and accessibility in strategic manufacturing. This deliberate approach has enabled us to successfully deliver projects to both small enterprises and some of the world's largest corporations with pride."
                      : "A Flair-Plastic-nél az elmúlt három évtizedben stratégiailag irányítottuk növekedésünket, hogy megőrizzük rugalmasságunkat és hozzáférhetőségünket a stratégiai gyártásban. Ez a tudatos megközelítés lehetővé tette számunkra, hogy büszkén teljesítsünk projekteket mind kis vállalkozások, mind a világ legnagyobb vállalatai számára."}
                  </p>
