          ...
          >
            ...
            >
              <span className="bg-gradient-to-r from-amber-700 to-amber-500 bg-clip-text text-transparent">
                {language === 'en' 
                  ? 'Explore Our Strategic Manufacturing Solutions'
                  : 'Fedezze fel Stratégiai Gyártási Megoldásainkat'}
              </span>
            </motion.h2>
            ...
            >
              <p className="text-lg leading-relaxed text-[#555]">
                {language === 'en'
                  ? 'At Flair-Plastic, we are uniquely positioned to expertly handle the complexities of both large and small-scale projects with a personalised touch, especially in the realm of strategic manufacturing.'
                  : 'A Flair-Plastic egyedülálló pozícióban van ahhoz, hogy szakértő módon kezelje mind a nagy-, mind a kisléptékű projektek összetettségét személyre szabott megközelítéssel, különösen a stratégiai gyártás területén.'}
              </p>
            </motion.div>
            ...
            >
              <p className="text-lg leading-relaxed text-gray-600">
                {language === 'en'
                  ? 'Our approach combines robust services to manage substantial projects with the nimbleness required to tailor our services to meet specific client needs.'
