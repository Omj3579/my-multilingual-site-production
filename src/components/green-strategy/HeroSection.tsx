      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-6">
        <div className="w-full max-w-screen-xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            {/* Professional description reflecting industry leadership */}
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              {language === 'en'
                ? 'Advancing sustainable manufacturing excellence through strategic renewable energy integration, optimized thermal management systems, and comprehensive circular economy principles.'
