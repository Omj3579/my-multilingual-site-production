import { Target, Cpu, Layers, CheckCircle, TrendingUp, Users, Globe } from 'lucide-react';
import type { OverviewContentMap } from '../types';

export const overviewContent: OverviewContentMap = {
  en: {
