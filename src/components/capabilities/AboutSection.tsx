      ...
      >
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            {/* Description with animated text */}            <AnimatedText
              text={description[language as keyof typeof description]}
              highlightWords={highlightWords[language as keyof typeof highlightWords] || []}
