...
const ManufacturingOverview: React.FC<ComponentProps> = ({ className = '' }) => {
  ...
  const videoY = useParallax([0, 0.5, 1], ['0%', '-5%', '-10%']);
  const textY = useParallax([0, 1], ['0%', '-8%']);
  
  // Decorative elements movement
  const circle1Movement = useParallax([0, 1], ['0%', '-10%'], ['0%', '20%']);
  const circle2Movement = useParallax([0, 1], ['0%', '10%'], ['0%', '15%']);
    ...
    <section className={`relative font-[Poppins] bg-white overflow-hidden ${className}`}>
      ...
      >
        <div className="bg-gradient-to-b from-[#f0f0f0] to-[#fcfcfc] h-[600px] relative overflow-hidden">
          <BackgroundPattern pattern="grid" opacity={0.15} />
      ...
      <motion.div 
        ...
        animate={{ y: controls === 'animate' ? 0 : 100, opacity: controls === 'animate' ? 1 : 0 }}
      ...
      >
        <div className="max-w-[1080px] mx-auto space-y-32">
          {/* First content block */}
          <ContentBlock
            title={manufacturingOverviewContent.sections.section1.title[language]}
            content={manufacturingOverviewContent.sections.section1.content[language]}
            layout="left"
          />
          ...
          >
            ...
            <motion.div className="lg:col-span-5 lg:col-start-8 lg:row-start-1">
              ...
              >
                <span className="relative inline-block">
                  {manufacturingOverviewContent.sections.section2.title[language]}
                  <motion.span
            ...
            <div className="lg:col-span-7 lg:col-start-1 lg:row-start-1">
              <ManufacturingGrid
                features={manufacturingCapabilities.map(cap => cap[language])}
                additionalContent={manufacturingOverviewContent.sections.section2.additionalContent[language]}
              />
            </div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <span className="relative z-10 mr-2">
                {manufacturingOverviewContent.cta[language]}
              </span>
              <motion.svg 
