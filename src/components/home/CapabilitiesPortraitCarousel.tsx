    ...
    <section className="w-full min-h-screen bg-gradient-to-b from-white to-gray-100 py-16 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 relative">
        ...
        <div className="text-center mb-16 relative">
          ...
          >
            {language === 'en' 
              ? 'Explore our comprehensive manufacturing solutions and advanced technologies that deliver superior results for every client'
              : 'Fedezze fel átfogó gyártási megoldásainkat és fejlett technológiáinkat, amelyek kiváló eredményeket biztosítanak minden ügyfél számára'}
          </motion.p>
        </div>
