...
export default function StrategicPartnershipTechInnovationLab() {
  ...
  useEffect(() => {
    ...
    // Fetch news data
    const article = getNewsBySlug('strategic-partnership-tech-innovation-lab');
    if (article) {
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://star-plus.com/resources/news/strategic-partnership-tech-innovation-lab`} />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntityOfPage": {
                "@type": "WebPage",
                "@id": `https://star-plus.com/resources/news/strategic-partnership-tech-innovation-lab`
              }
            })
          }}
        />
