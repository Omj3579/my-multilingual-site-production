      ...
      try {
        ...
        try {
          ...
          if (apiRes.ok) {
            ...
            const posts = Array.isArray(apiData) ? apiData : apiData.news || apiData.posts || [];
  ...
  async function fetchRelatedPosts(tags: string[], currentSlug: string) {
    try {
      ...
      if (response.ok) {
        ...
        const posts = Array.isArray(data) ? data : data.news || data.posts || [];
        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center max-w-md mx-auto p-6">
            ...
            <p className="text-gray-600 mb-6">
              The requested news could not be found or may have been moved.
            </p>
            <Link
              href="/resources/news"
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav className="flex items-center space-x-2 text-sm">
              ...
              <Link href={`/resources/news`} className="text-gray-500 hover:text-gray-700 capitalize">
                {category.replace('-', ' ')}
              </Link>
              <span className="text-gray-400">/</span>
