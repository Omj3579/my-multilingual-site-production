...
export default function MillionTonsRecycledMilestone() {
  ...
  useEffect(() => {
    ...
    // Fetch news data
    const article = getNewsBySlug('million-tons-recycled-milestone');
    if (article) {
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://star-plus.com/resources/news/million-tons-recycled-milestone`} />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntityOfPage": {
                "@type": "WebPage",
                "@id": `https://star-plus.com/resources/news/million-tons-recycled-milestone`
              }
            })
          }}
        />
