...
export default function SustainabilityAwardGreenManufacturingExcellence() {
  ...
  useEffect(() => {
    ...
    // Fetch news data
    const article = getNewsBySlug('sustainability-award-green-manufacturing-excellence');
    if (article) {
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://star-plus.com/resources/news/sustainability-award-green-manufacturing-excellence`} />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntityOfPage": {
                "@type": "WebPage",
                "@id": `https://star-plus.com/resources/news/sustainability-award-green-manufacturing-excellence`
              }
            })
          }}
        />
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-4">
                  <Link href="/resources/news/flair-plastic-announces-major-expansion" className="block group">
                    <div className="text-sm font-medium text-gray-900 group-hover:text-blue-600">
                      Major European Expansion Announced
                    </div>
                    <div className="text-xs text-gray-500 mt-1">Company • Expansion</div>
                  </Link>
