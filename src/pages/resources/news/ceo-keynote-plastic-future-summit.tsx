...
export default function CEOKeynotePlasticFutureSummit() {
  ...
  useEffect(() => {
    ...
    // Fetch news data
    const article = getNewsBySlug('ceo-keynote-plastic-future-summit');
    if (article) {
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://star-plus.com/resources/news/ceo-keynote-plastic-future-summit`} />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntityOfPage": {
                "@type": "WebPage",
                "@id": `https://star-plus.com/resources/news/ceo-keynote-plastic-future-summit`
              }
            })
          }}
        />
