...
const SustainablePackagingInnovationCaseStudy = () => {
  const { language } = useLanguage();
  
  // Get the case study data
  const caseStudy = getCaseStudyBySlug('sustainable-packaging-innovation');
...
export default SustainablePackagingInnovationCaseStudy;
