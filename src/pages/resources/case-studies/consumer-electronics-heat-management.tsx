...
const ConsumerElectronicsHeatManagementCaseStudy = () => {
  const { language } = useLanguage();
  
  // Get the case study data
  const caseStudy = getCaseStudyBySlug('consumer-electronics-heat-management');
...
export default ConsumerElectronicsHeatManagementCaseStudy;
