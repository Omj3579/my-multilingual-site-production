...
const AutomotiveLightweightComponentsCaseStudy = () => {
  const { language } = useLanguage();
  
  // Get the case study data
  const caseStudy = getCaseStudyBySlug('automotive-lightweight-components');
...
export default AutomotiveLightweightComponentsCaseStudy;
