...
import { AssemblyHeroRefactored } from '../../../components/assembly/hero';
import { AssemblyOverviewRefactored } from '../../../components/assembly/overview';
import { AssemblyCapabilitiesRefactored } from '../../../components/assembly/capabilities';
import { AssemblyShowcaseRefactored } from '../../../components/assembly/showcase';
import { AssemblyInnovationRefactored } from '../../../components/assembly/innovation';
import { AssemblySolutionsRefactored } from '../../../components/assembly/solutions-interactive';
import { AssemblyImpactRefactored } from '../../../components/assembly/impact';
import { AssemblyCallToActionRefactored } from '../../../components/assembly/call-to-action';
...
const Assembly = () => {
  ...
  return (
    <CapabilitiesLayout>
      ...
      </motion.nav>      {/* Main Content */}
      <main className="relative">
        <section id="hero">
          <AssemblyHeroRefactored />
        </section>
        
        <section id="overview">
          <AssemblyOverviewRefactored />
        </section>
        
        <section id="capabilities">
          <AssemblyCapabilitiesRefactored />
        </section>
        
        <section id="showcase">
          <AssemblyShowcaseRefactored />
        </section>
        
        <section id="innovation">
          <AssemblyInnovationRefactored />
        </section>
        
        <section id="solutions">
          <AssemblySolutionsRefactored />
        </section>
        
        <section id="impact">
          <AssemblyImpactRefactored />
        </section>
        
        <section id="cta">
          <AssemblyCallToActionRefactored />
        </section>
      </main>
