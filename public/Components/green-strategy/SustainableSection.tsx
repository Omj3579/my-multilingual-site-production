          ...
          >
            ...
            <div className="w-full lg:w-2/5 order-1 lg:order-2">
              <div className="relative">
                ...
                <div className="absolute -top-10 -right-10 -bottom-10 -left-10 bg-gradient-to-br from-green-100/50 to-green-300/20 rounded-full transform rotate-12 blur-xl"></div>
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
                  <img
                    ...
                    alt="Interior sustainability view"
