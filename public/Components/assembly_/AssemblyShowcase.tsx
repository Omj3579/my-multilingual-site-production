...
const AssemblyShowcase = () => {
  ...
  const content = showcaseContent[language as keyof typeof showcaseContent];
        ...
        >
          ...
          <motion.div variants={itemVariants} className="relative">
            ...
            <div className="flex justify-center mb-8">
              <div className="flex items-center space-x-4 p-2 bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200/50 shadow-lg">                <button
                ...
                <div className="flex space-x-2">
                  {content.services.map((_, index) => (                    <button
                      key={index}
              ...
              >
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  >
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex space-x-2">
                            <button 
                              ...
                              aria-label={language === 'en' ? 'Play monitoring' : 'Monitoring indítása'}
                            >
                              <Play size={16} />
                            </button>                            <button 
                              className="p-2 bg-gray-600 hover:bg-gray-700 rounded-lg transition-colors"
                              aria-label={language === 'en' ? 'Maximize view' : 'Nézet nagyítása'}
                            >
                              <Maximize2 size={16} />
                            </button>
                            <button 
                              className="p-2 bg-gray-600 hover:bg-gray-700 rounded-lg transition-colors"
                              aria-label={language === 'en' ? 'Share monitoring' : 'Monitoring megosztása'}
                            >
                              <Share2 size={16} />
                            </button>
                          </div>
                    ...
                    {/* Floating Action Buttons */}                    <motion.button
                      ...
                      whileTap={{ scale: 0.9 }}
                      aria-label={language === 'en' ? 'Download assembly data' : 'Összeszerelési adatok letöltése'}
                    >
                      <Download size={20} />
                    </motion.button>
                  </motion.div>
