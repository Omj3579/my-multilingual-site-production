...
const FutureOfBioplasticsManufacturingPost = () => {
  const { language } = useLanguage();
  
  // Get the blog post data
  const blogPost = getBlogPostBySlug('future-of-bioplastics-manufacturing');
...
export default FutureOfBioplasticsManufacturingPost;
