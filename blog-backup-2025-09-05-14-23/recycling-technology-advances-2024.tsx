...
const RecyclingTechnologyAdvancesPost = () => {
  const { language } = useLanguage();
  
  // Get the blog post data
  const blogPost = getBlogPostBySlug('recycling-technology-advances-2024');
...
export default RecyclingTechnologyAdvancesPost;
